...
namespace Alopeyk.Net.Dto
{
    ...
    {
        /// <summary>
        /// Currently you can send up to 100 requests every minute.
        /// You will be able to check the current quotas on every response header.
        /// </summary>
        ...
        /// <summary>
        /// Currently you can send up to 43200 requests every day.
        /// You will be able to check the current quotas on every response header.
        /// </summary>
