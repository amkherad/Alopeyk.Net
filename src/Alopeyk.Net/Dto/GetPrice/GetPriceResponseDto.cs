...
namespace Alopeyk.Net.Dto.GetPrice
{
    public class GetPriceResponseDto
    {
        ...
        /// <summary>
        /// Indicates payment type of the order (payment by credit or cash). Will be true only if you have enough credit on your account for that order. In the case of credit deficiency, or cashed=true, this attribute will be set to false.
        /// </summary>
